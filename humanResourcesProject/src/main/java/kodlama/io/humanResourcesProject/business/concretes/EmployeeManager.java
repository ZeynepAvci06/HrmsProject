...
public class EmployeeManager implements EmployeeService {
	...
	@Override//ekleme işlemini destekleyen bir service.nerden alacak?dao'dan tabiki.
	...
	public DataResult<Employee> findById(int id) {
		return new SuccessDataResult<Employee>(this.employeeDao.findById(id), "Id'ye göre Data bulundu");
